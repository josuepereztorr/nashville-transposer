...
// each array marks which of the 12 chromatic semitones belog to that key's major scale
...
// NOTE: lookup_table[] and major_scales must stay in the smae order.
// lookup table
...
// major scales
static const char *major_scales[12] = {"C Major", "C# Major", "D Major", "D# Major", "E Major", "F Major", "F# Major", "G Major", "G# Major", "A Major", "A# Major", "B Major"};
